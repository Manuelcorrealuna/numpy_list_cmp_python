...
if __name__ == '__main__':
    ...
    print('El personal a deshabilitar es:', personal_1_10)
    print('La cantidad de personas a deshabilitar es:', len(personal_1_10))
    ...
    # personal_valido = [.....]
    personal_valido = [x if(x) in id_validos else 0 for x in accesos]
    print('personal habilitado:', personal_valido)
    print("terminamos")